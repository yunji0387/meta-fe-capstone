...
// export default function ReservationForm({ onSubmit, initialData, availableTimes, onTimeChange, time, onDateChange, date, onGuestsChange, guests, onOccasionChange, occasion }) {
